...
// if everything is ok, try to upload file
        ...
        if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], "uploads/uploadedExcelFileSales.xlsx")) {
            echo "The file " . htmlspecialchars(basename($_FILES["fileToUpload"]["name"])) . " has been uploaded.";

            //this part is for database iserton
            $uploadController = new UploadController();

            $uploadController->saveUploadedSalesDataIntoDatabase();
...
function deployFile() {
    ...
    header("Location:uploadSales.php");
}
?>
<!DOCTYPE html>
<html>

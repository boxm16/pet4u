...
echo "<hr>";
echo "<hr>";
echo "<a href='https://files.fm/u/67tfnuwr7'>OLD VERSION DOWNLOAD MIRROR</a>";
echo "<br>";
echo "<br>";
echo "<img src='images/qr_3.png' style='width:200px;height:200px;' >";
echo "<br>";
echo "<br>";
echo "<hr>";
echo "<hr>";
echo "<a href='https://appsenjoy.com/en/tp2aXyHpQAXNcob/file'>OLD VERSION DOWNLOAD  ANOTHER MIRROR</a>";
echo "<br>";
echo "<br>";
echo "<img src='images/qr_4.png' style='width:200px;height:200px;' >";
echo "<br>";
